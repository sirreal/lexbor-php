...
final class Macintosh
{
    private const string LABEL = 'macintosh';
    private const string TABLE_KEY = 'macintosh';

    /**
     * Lexbor's lxb_encoding_single_index_macintosh table for bytes 0x80-0xFF.
     *
     * @var list<int>
     */
