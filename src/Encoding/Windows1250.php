...
final class Windows1250
{
    private const string LABEL = 'Windows-1250';
    private const string TABLE_KEY = 'windows_1250';

    /**
     * Lexbor's lxb_encoding_single_index_windows_1250 table for bytes 0x80-0xFF.
     *
     * @var list<int>
     */
