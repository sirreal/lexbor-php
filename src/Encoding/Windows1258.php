...
final class Windows1258
{
    private const string LABEL = 'Windows-1258';
    private const string TABLE_KEY = 'windows_1258';

    /**
     * Lexbor's lxb_encoding_single_index_windows_1258 table for bytes 0x80-0xFF.
     *
     * @var list<int>
     */
