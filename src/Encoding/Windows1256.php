...
final class Windows1256
{
    private const string LABEL = 'Windows-1256';
    private const string TABLE_KEY = 'windows_1256';

    /**
     * Lexbor's lxb_encoding_single_index_windows_1256 table for bytes 0x80-0xFF.
     *
     * @var list<int>
     */
