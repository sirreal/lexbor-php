...
final class Windows1257
{
    private const string LABEL = 'Windows-1257';
    private const string TABLE_KEY = 'windows_1257';

    /**
     * Lexbor's lxb_encoding_single_index_windows_1257 table for bytes 0x80-0xFF.
     *
     * @var list<int>
     */
