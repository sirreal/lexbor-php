...
final class Iso885914
{
    private const string LABEL = 'ISO-8859-14';
    private const string TABLE_KEY = 'iso_8859_14';

    /**
     * Lexbor's lxb_encoding_single_index_iso_8859_14 table for bytes 0x80-0xFF.
     *
     * @var list<int>
     */
