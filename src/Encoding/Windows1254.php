...
final class Windows1254
{
    private const string LABEL = 'Windows-1254';
    private const string TABLE_KEY = 'windows_1254';

    /**
     * Lexbor's lxb_encoding_single_index_windows_1254 table for bytes 0x80-0xFF.
     *
     * @var list<int>
     */
