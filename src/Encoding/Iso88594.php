...
final class Iso88594
{
    private const string LABEL = 'ISO-8859-4';
    private const string TABLE_KEY = 'iso_8859_4';

    /**
     * Lexbor's lxb_encoding_single_index_iso_8859_4 table for bytes 0x80-0xFF.
     *
     * @var list<int>
     */
