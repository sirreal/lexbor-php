...
final class Windows1251
{
    private const string LABEL = 'Windows-1251';
    private const string TABLE_KEY = 'windows_1251';

    /**
     * Lexbor's lxb_encoding_single_index_windows_1251 table for bytes 0x80-0xFF.
     *
     * @var list<int>
     */
