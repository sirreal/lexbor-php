...
final class Windows1253
{
    private const string LABEL = 'Windows-1253';
    private const string TABLE_KEY = 'windows_1253';

    /**
     * Lexbor's lxb_encoding_single_index_windows_1253 table for bytes 0x80-0xFF.
     *
     * @var list<int>
     */
