...
final class Iso88592
{
    private const string LABEL = 'ISO-8859-2';
    private const string TABLE_KEY = 'iso_8859_2';

    /**
     * Lexbor's lxb_encoding_single_index_iso_8859_2 table for bytes 0x80-0xFF.
     *
     * @var list<int>
     */
