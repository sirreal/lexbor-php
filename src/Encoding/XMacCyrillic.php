...
final class XMacCyrillic
{
    private const string LABEL = 'x-mac-cyrillic';
    private const string TABLE_KEY = 'x_mac_cyrillic';

    /**
     * Lexbor's lxb_encoding_single_index_x_mac_cyrillic table for bytes 0x80-0xFF.
     *
     * @var list<int>
     */
